        ...
        logSuccess() {
            if (this.logSuccess) {
                if (this.prenom == null || this.nom == null || this.poste == null) {
                    ...
                    this.$store.commit('SET_EMAIL', userInfos.email);
                    this.$store.commit('SET_TOKEN', userInfos.token);
                    this.$store.commit('SET_ID', userInfos.id);
                    ...
                    this.$store.commit('SET_EMAIL', userInfos.email);
                    this.$store.commit('SET_TOKEN', userInfos.token);
                    this.$store.commit('SET_PRENOM', userInfos.prenom);
                    this.$store.commit('SET_NOM', userInfos.nom);
                    this.$store.commit('SET_POSTE', userInfos.poste);
                    this.$store.commit('SET_ID', userInfos.id);
